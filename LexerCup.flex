...
"adda"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ADDA, yychar, yyline, yytext());}
"addb"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ADDB, yychar, yyline, yytext());}
"addd"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ADDD, yychar, yyline, yytext());}
"anda"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ANDA, yychar, yyline, yytext());}
"andb"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ANDB, yychar, yyline, yytext());}
"asl"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ASL, yychar, yyline, yytext());}
"asr"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ASR, yychar, yyline, yytext());}
"bclr"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_BCLR, yychar, yyline, yytext());}
"bita"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_BITA, yychar, yyline, yytext());}
"bitb"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_BITB, yychar, yyline, yytext());}
"brclr"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_BRCLR, yychar, yyline, yytext());}
"brset"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_BRSET, yychar, yyline, yytext());}
"bset"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_BSET, yychar, yyline, yytext());}
"clr"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_CLR, yychar, yyline, yytext());}
"cmpa"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_CMPA, yychar, yyline, yytext());}
"cmpb"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_CMPB, yychar, yyline, yytext());}
"com"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_COM, yychar, yyline, yytext());}
"cpd"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_CPD, yychar, yyline, yytext());}
"cpx"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_CPX, yychar, yyline, yytext());}
"cpy"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_CPY, yychar, yyline, yytext());}
"dec"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_DEC, yychar, yyline, yytext());}
"eora"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_EORA, yychar, yyline, yytext());}
"eorb"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_EORB, yychar, yyline, yytext());}
"inc"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_INC, yychar, yyline, yytext());}
"jmp"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_JMP, yychar, yyline, yytext());}
"jsr"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_JSR, yychar, yyline, yytext());}
"ldaa"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_LDAA, yychar, yyline, yytext());}
"ldab"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_LDAB, yychar, yyline, yytext());}
"ldd"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_LDD, yychar, yyline, yytext());}
"lds"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_LDS, yychar, yyline, yytext());}
"ldx"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_LDX, yychar, yyline, yytext());}
"ldy"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_LDY, yychar, yyline, yytext());}
"lsl"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_LSL, yychar, yyline, yytext());}
"lsr"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_LSR, yychar, yyline, yytext());}
"neg"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_NEG, yychar, yyline, yytext());}
"oraa"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ORAA, yychar, yyline, yytext());}
"orab"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ORAB, yychar, yyline, yytext());}
"rol"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ROL, yychar, yyline, yytext());}
"ror"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_ROR, yychar, yyline, yytext());}
"sbca"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_SBCA, yychar, yyline, yytext());}
"sbcb"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_SBCB, yychar, yyline, yytext());}
"staa"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_STAA, yychar, yyline, yytext());}
"stab"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_STAB, yychar, yyline, yytext());}
"std"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_STD, yychar, yyline, yytext());}
"sts"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_STS, yychar, yyline, yytext());}
"stx"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_STX, yychar, yyline, yytext());}
"sty"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_STY, yychar, yyline, yytext());}
"suba"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_SUBA, yychar, yyline, yytext());}
"subb"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_SUBB, yychar, yyline, yytext());}
"subd"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_SUBD, yychar, yyline, yytext());}
"tst"{espacio}+"$"{H}{2}",X" {return new Symbol(sym.INDX_TST, yychar, yyline, yytext());}
...
"adda"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ADDA, yychar, yyline, yytext());}
"addb"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ADDB, yychar, yyline, yytext());}
"addd"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ADDD, yychar, yyline, yytext());}
"anda"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ANDA, yychar, yyline, yytext());}
"andb"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ANDB, yychar, yyline, yytext());}
"asl"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ASL, yychar, yyline, yytext());}
"asr"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ASR, yychar, yyline, yytext());}
"bclr"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_BCLR, yychar, yyline, yytext());}
"bita"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_BITA, yychar, yyline, yytext());}
"bitb"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_BITB, yychar, yyline, yytext());}
"brclr"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_BRCLR, yychar, yyline, yytext());}
"brset"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_BRSET, yychar, yyline, yytext());}
"bset"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_BSET, yychar, yyline, yytext());}
"clr"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_CLR, yychar, yyline, yytext());}
"cmpa"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_CMPA, yychar, yyline, yytext());}
"cmpb"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_CMPB, yychar, yyline, yytext());}
"com"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_COM, yychar, yyline, yytext());}
"cpd"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_CPD, yychar, yyline, yytext());}
"cpx"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_CPX, yychar, yyline, yytext());}
"cpy"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_CPY, yychar, yyline, yytext());}
"dec"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_DEC, yychar, yyline, yytext());}
"eora"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_EORA, yychar, yyline, yytext());}
"eorb"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_EORB, yychar, yyline, yytext());}
"inc"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_INC, yychar, yyline, yytext());}
"jmp"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_JMP, yychar, yyline, yytext());}
"jsr"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_JSR, yychar, yyline, yytext());}
"ldaa"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_LDAA, yychar, yyline, yytext());}
"ldab"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_LDAB, yychar, yyline, yytext());}
"ldd"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_LDD, yychar, yyline, yytext());}
"lds"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_LDS, yychar, yyline, yytext());}
"ldx"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_LDX, yychar, yyline, yytext());}
"ldy"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_LDY, yychar, yyline, yytext());}
"lsl"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_LSL, yychar, yyline, yytext());}
"lsr"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_LSR, yychar, yyline, yytext());}
"neg"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_NEG, yychar, yyline, yytext());}
"oraa"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ORAA, yychar, yyline, yytext());}
"orab"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ORAB, yychar, yyline, yytext());}
"rol"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDX_ROL, yychar, yyline, yytext());}
"ror"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_ROR, yychar, yyline, yytext());}
"sbca"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_SBCA, yychar, yyline, yytext());}
"sbcb"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_SBCB, yychar, yyline, yytext());}
"staa"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_STAA, yychar, yyline, yytext());}
"stab"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_STAB, yychar, yyline, yytext());}
"std"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_STD, yychar, yyline, yytext());}
"sts"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_STS, yychar, yyline, yytext());}
"stx"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_STX, yychar, yyline, yytext());}
"sty"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_STY, yychar, yyline, yytext());}
"suba"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_SUBA, yychar, yyline, yytext());}
"subb"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_SUBB, yychar, yyline, yytext());}
"subd"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_SUBD, yychar, yyline, yytext());}
"tst"{espacio}+"$"{H}{2}",Y" {return new Symbol(sym.INDY_TST, yychar, yyline, yytext());}
