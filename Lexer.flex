...
{espacio}+"bclr"{espacio}+"$"{H}{2}",X" {lexeme=yytext(); return INDX_BCLR;}
{espacio}+"bita"{espacio}+"$"{H}{2}",X" {lexeme=yytext(); return INDX_BITA;}
{espacio}+"bitb"{espacio}+"$"{H}{2}",X" {lexeme=yytext(); return INDX_BITB;}
{espacio}+"brclr"{espacio}+"$"{H}{2}",X" {lexeme=yytext(); return INDX_BRCLR;}
{espacio}+"brset"{espacio}+"$"{H}{2}",X" {lexeme=yytext(); return INDX_BRSET;}
{espacio}+"bset"{espacio}+"$"{H}{2}",X" {lexeme=yytext(); return INDX_BSET;}
...
{espacio}+"bclr"{espacio}+"$"{H}{2}",Y" {lexeme=yytext(); return INDY_BCLR;}
{espacio}+"bita"{espacio}+"$"{H}{2}",Y" {lexeme=yytext(); return INDY_BITA;}
{espacio}+"bitb"{espacio}+"$"{H}{2}",Y" {lexeme=yytext(); return INDY_BITB;}
{espacio}+"brclr"{espacio}+"$"{H}{2}",Y" {lexeme=yytext(); return INDY_BRCLR;}
{espacio}+"brset"{espacio}+"$"{H}{2}",Y" {lexeme=yytext(); return INDY_BRSET;}
{espacio}+"bset"{espacio}+"$"{H}{2}",Y" {lexeme=yytext(); return INDY_BSET;}
